    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="shipping_status.php">Shipping status</a></li>
                <li><a href="all_consignments.php">Consignments</a></li>
            </ul>
        </li>
        
      
      <li>
          <a href="sent_packages.php">
          <div class=" icon-img">
        ...
        <li>
          <a href="received_packages.php">
          <div class=" icon-img">
            <img src="assets/img/icons/worker.png" alt="" />
            </div>
            <span class="links_name">Received</span>
          </a>
        </li>
        ...
        <li class="dropdown">
            <a href="#">
                ...
                <i class="uil uil-angle-down dropdown-icon"></i> <!-- Dropdown icon -->
            </a>
            <ul class="dropdown-menu">
