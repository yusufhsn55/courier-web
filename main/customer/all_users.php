            ...
            <ul class="details">
                ...
                <li class="topic">
                    <select id="roleFilter" onchange="filterByRole(this.value)">
                        ...
                        <option value="dispatcher" <?php if ($selected_role == 'dispatcher') echo 'selected'; ?>>Dispatcher</option>
                        <option value="employee" <?php if ($selected_role == 'employee') echo 'selected'; ?>>Employee</option>
                    </select>
                </li>
            </ul>
